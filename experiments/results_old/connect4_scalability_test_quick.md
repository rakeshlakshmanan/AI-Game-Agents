...
- Time budget per agent: **1 minute(s)**
...
|--------|---------------------|--------------------------|
| Nodes explored in 1 min | 893,121 | 898,573 |
| Nodes per second | 14,885 | 14,976 |
| % of tree explored | 0.00000657% | 0.00000661% |
| Estimated time for full tree | 2.90e+01 years | 2.88e+01 years |
| Timed out | Yes | Yes |

## Analysis

Alpha-Beta explored **1.0x more nodes** than Minimax in the same time budget.
